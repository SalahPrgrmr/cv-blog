...
@section('content')
	...
	<div class="colors_sel">
		...
		<ul>
			<li><a href="index-1-particles.html"><span style="background:#304fff;"></span></a></li>
			<li><a href="../green/index-1-particles.html"><span style="background:#689f38;"></span></a></li>
			<li><a href="../orange/index-1-particles.html"><span style="background:#ef6c00;"></span></a></li>
			<li><a href="../pink/index-1-particles.html"><span style="background:#ff4181;"></span></a></li>
			<li><a href="../purple/index-1-particles.html"><span style="background:#9C27B0;"></span></a></li>
			<li><a href="../red/index-1-particles.html"><span style="background:#ed3b3b;"></span></a></li>
		</ul>
	...
	<div class="page" id="home-section">
		...
		<div class="started-bg">
			<div class="slide" style="background-image: url(assets/images/particles-bg.jpg);"></div>
		</div>
		...
		<div class="container">
			...
			<div class="section started">
				<div class="st-box">
					...
					<div class="st-image"><img src="assets/images/man.png" alt="" /></div>
					...
					<div class="st-soc">
						...
						<a target="blank" href="https://www.youtube.com/" class="btn_animated">
				...
				<div class="section works" id="works-section">
					...
					<div class="row box-items">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-icons animated">
							<div class="image">
								<a href="#popup-4" class="has-popup"><img src="assets/images/works/work4.jpg" alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-ui animated">
							<div class="image">
								<a href="#popup-5" class="has-popup"><img src="assets/images/works/work5.jpg" alt="" /></a>
							</div>
							<div class="content-box">
						...
						<div class="col col-m-12 col-t-6 col-d-4 box-item f-ui animated">
							<div class="image">
								<a href="#popup-6" class="has-popup"><img src="assets/images/works/work6.jpg" alt="" /></a>
							</div>
							<div class="content-box">
								<div class="category">UI Kits</div>
					...
					<div class="reviews-carousel animated">
						<div class="owl-carousel">
							<div class="item">
								<div class="content-box">
									<div class="reviews-item">
										<div class="image"><img src="assets/images/clients/rev1.jpg" alt="" /></div>
							...
							<div class="item">
								<div class="content-box">
									<div class="reviews-item">
										<div class="image"><img src="assets/images/clients/rev2.jpg" alt="" /></div>
							...
							<div class="item">
								<div class="content-box">
									<div class="reviews-item">
										<div class="image"><img src="assets/images/clients/rev3.jpg" alt="" /></div>
					...
					<div class="row">
						<div class="col col-m-12 col-t-6 col-d-6">
							<div class="blog_item animated">
								<div class="image">
									<a href="blog-page.html"><img src="assets/images/blog/blog1.jpg" alt="" /></a>
								</div>
								<div class="content-box">
									<div class="i_title">
						...
						<div class="col col-m-12 col-t-6 col-d-6">
							<div class="blog_item animated">
								<div class="image">
									<a href="blog-page.html"><img src="assets/images/blog/blog2.jpg" alt="" /></a>
								</div>
								<div class="content-box">
									<div class="i_title">
										<div class="icon"><strong>27</strong> July</div>
